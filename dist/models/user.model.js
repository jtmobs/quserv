...
var userSchema = new mongoose.Schema({
  ...
  email: {
    ...
    validate: [_validator.isEmail, "Provide a valid email address"],
  ...
  password: {
    ...
    validate: {
      validator: function validator(value) {
        return _validator.isStrongPassword(value, {
          minUppercase: 1,
          minLowercase: 1,
          minNumbers: 1,
          minSymbols: 1
      ...
      message: "Password {VALUE} should contain minimum 1 => uppercase, lowercase, number and symbol"
    },
  ...
  avatar: {
    url: {
      type: String,
      validate: [_validator.isURL, "Please provide a valid avatar URL"],
  ...
  phone: {
    type: String,
    required: [true, "Please, provide your phone number, i.e.: +8801xxxxxxxxx"],
    validate: {
      validator: function validator(value) {
        return _validator.isMobilePhone(value, "bn-BD", {
          strictMode: true
        });
      },
      message: "Phone number {VALUE} is not valid. Please, retry like +8801xxxxxxxxx"
    },
    unique: true
  },
  // for role
...
userSchema.methods.comparePassword = function (password, hash) {
  var isPasswordValid = bcrypt.compareSync(password, hash);
